      ...
      <main className="min-h-screen py-12 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <section className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className={`text-gray-600 mb-6 ${language === 'hindi' ? 'hindi-text' : ''
              }`}>
              {language === 'hindi'
    ...
    <main id="main-content" className="min-h-screen py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="flex justify-between items-center mb-8">
          <div>
            <h1 className={`text-3xl md:text-4xl font-bold text-spiritual-primary mb-2 ${language === 'hindi' ? 'hindi-text' : ''
              }`}>
        ...
        <section aria-label="Your celebrations">
          {celebrations.length === 0 ? (
            <div className="bg-white rounded-xl shadow-lg p-12 text-center">
              ...
              <h3 className={`text-xl font-semibold text-gray-700 mb-2 ${language === 'hindi' ? 'hindi-text' : ''
                }`}>
